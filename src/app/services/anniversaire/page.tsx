...
export default function AnniversairePage() {
  ...
  return (
    <>
      ...
      {/* Organisation anniversaire par ville */}
      <section className="py-20 bg-champagne">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl font-heading font-bold text-taupe mb-4">
              Organisation d&apos;anniversaire dans votre ville
            </h2>
          </div>
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              <Link
                key={city.slug}
                href={`/organisation-anniversaire/${city.slug}`}
              ...
              >
                Organisation Anniversaire {city.name}
              </Link>
            ))}
          </div>
        </div>
